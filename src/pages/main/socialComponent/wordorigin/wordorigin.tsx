  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      <div style={{opacity:'0.3'}}>
        <Box
          sx={{ textAlign: "right", marginTop: isLargeScreen ? "0px" : "20px" }}
        >
          ...
          <Common
            text={dummy2.text}
            desc={dummy2.desc}
            subtitle1={dummy2.subtitle1}
            subtitle2={dummy2.subtitle2}
          />
          <Common
            text={dummy1.text}
            desc={dummy1.desc}
            subtitle1={dummy1.subtitle1}
            subtitle2={dummy1.subtitle2}
          />
          <Common
            text={dummy3.text}
            desc={dummy3.desc}
            subtitle1={dummy3.subtitle1}
            subtitle2={dummy3.subtitle2}
          />
        </Box>
      </div>
    </div>
